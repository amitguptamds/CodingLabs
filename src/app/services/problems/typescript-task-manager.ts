...
export const typescriptTaskManager: Problem = {
...
Implement the \`TaskManagerImpl\` class with methods to add, complete, remove, list, and filter tasks by priority.
...
`
    ...
    boilerplateCode: `// Multi-file problem — edit manager.ts
class TaskManagerImpl {
    addTask(title: string, priority: "low" | "medium" | "high"): Task {
        // TODO: implement
    }
